...
export function createSwapRouter(swapService: SwapService): express.Router {
    ...
    router.get('/v0/prices', asyncHandler(handlers.getTokenPricesAsync.bind(handlers, SwapVersion.V0)));
    ...
    router.get('/v1/prices', asyncHandler(handlers.getTokenPricesAsync.bind(handlers, SwapVersion.V1)));
