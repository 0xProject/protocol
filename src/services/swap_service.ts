...
export class SwapService {
    ...
    private async _getSwapQuoteForNativeWrappedAsync(
        ...
        const attributedCalldata = serviceUtils.attributeCallData(data, affiliateAddress ?? null);
    ...
    private async _getSwapQuotePartialTransactionAsync(
        ...
        const { affiliatedData, decodedUniqueId } = serviceUtils.attributeCallData(data, affiliateAddress ?? null);
        return {
            to,
            value,
            data: affiliatedData,
