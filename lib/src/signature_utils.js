...
exports.ecSignHashWithKey = exports.eip712SignHashWithKey = exports.eip712SignTypedDataWithKey = exports.eip712SignTypedDataWithSignatureFnAsync = exports.ethSignHashWithSignatureFnAsync = exports.eip712SignTypedDataWithProviderAsync = exports.ethSignHashWithKey = exports.ethSignHashWithProviderAsync = exports.SIGNATURE_ABI = exports.SignatureType = void 0;
 ...
 */
function ethSignHashWithSignatureFnAsync(hash, signer, signMessageAsync) {
    return __awaiter(this, void 0, void 0, function* () {
        const rpcSig = yield signMessageAsync(hash, signer);
        return Object.assign(Object.assign({}, parseRpcSignature(rpcSig)), { signatureType: SignatureType.EthSign });
    });
}
exports.ethSignHashWithSignatureFnAsync = ethSignHashWithSignatureFnAsync;
/**
 * Sign a typed data object with the EIP712 signature type using a compatible signature function
 */
function eip712SignTypedDataWithSignatureFnAsync(data, signer, signTypedDataAsync) {
    return __awaiter(this, void 0, void 0, function* () {
        const rpcSig = yield signTypedDataAsync(data, signer);
        return Object.assign(Object.assign({}, parseRpcSignature(rpcSig)), { signatureType: SignatureType.EIP712 });
    });
}
exports.eip712SignTypedDataWithSignatureFnAsync = eip712SignTypedDataWithSignatureFnAsync;
/**
