...
function ethSignHashWithProviderAsync(hash, signer, provider) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return Object.assign({}, parseRpcSignature(rpcSig), { signatureType: SignatureType.EthSign });
    });
}
...
function ethSignHashWithKey(hash, key) {
    ...
    return Object.assign({}, ecSignHashWithKey(ethHash, key), { signatureType: SignatureType.EthSign });
}
...
function eip712SignTypedDataWithProviderAsync(data, signer, provider) {
    return __awaiter(this, void 0, void 0, function* () {
        const w3w = new web3_wrapper_1.Web3Wrapper(utils_1.providerUtils.standardizeOrThrow(provider));
        const rpcSig = yield w3w.signTypedDataV4Async(signer, data);
        return Object.assign({}, parseRpcSignature(rpcSig), { signatureType: SignatureType.EIP712 });
    });
}
...
function eip712SignTypedDataWithKey(typedData, key) {
    ...
    return Object.assign({}, ecSignHashWithKey(hash, key), { signatureType: SignatureType.EIP712 });
}
