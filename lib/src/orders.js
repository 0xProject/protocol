...
exports.RfqLiteOrder = exports.RfqOrder = exports.LimitOrder = exports.OrderBase = exports.OrderStatus = void 0;
...
const LIMIT_ORDER_DEFAULT_VALUES = Object.assign(Object.assign({}, COMMON_ORDER_DEFAULT_VALUES), { taker: utils_1.NULL_ADDRESS, pool: utils_1.hexUtils.leftPad(0), takerTokenFeeAmount: constants_1.ZERO, sender: utils_1.NULL_ADDRESS, feeRecipient: utils_1.NULL_ADDRESS });
const RFQ_ORDER_DEFAULT_VALUES = Object.assign(Object.assign({}, COMMON_ORDER_DEFAULT_VALUES), { taker: utils_1.NULL_ADDRESS, pool: utils_1.hexUtils.leftPad(0), txOrigin: utils_1.NULL_ADDRESS });
const RFQLITE_ORDER_DEFAULT_VALUES = Object.assign(Object.assign({}, COMMON_ORDER_DEFAULT_VALUES), { txOrigin: utils_1.NULL_ADDRESS });
...
class RfqLiteOrder extends OrderBase {
    constructor(fields = {}) {
        const _fields = Object.assign(Object.assign({}, RFQ_ORDER_DEFAULT_VALUES), fields);
        super(_fields);
        this.txOrigin = _fields.txOrigin;
    ...
    clone(fields = {}) {
        return new RfqLiteOrder(Object.assign({ makerToken: this.makerToken, takerToken: this.takerToken, makerAmount: this.makerAmount, takerAmount: this.takerAmount, maker: this.maker, txOrigin: this.txOrigin, expiry: this.expiry, salt: this.salt, chainId: this.chainId, verifyingContract: this.verifyingContract }, fields));
    }
    getStructHash() {
        return utils_1.hexUtils.hash(utils_1.hexUtils.concat(utils_1.hexUtils.leftPad(RfqLiteOrder.TYPE_HASH), utils_1.hexUtils.leftPad(this.makerToken), utils_1.hexUtils.leftPad(this.takerToken), utils_1.hexUtils.leftPad(this.makerAmount), utils_1.hexUtils.leftPad(this.takerAmount), utils_1.hexUtils.leftPad(this.maker), utils_1.hexUtils.leftPad(this.txOrigin), utils_1.hexUtils.leftPad(this.expiry), utils_1.hexUtils.leftPad(this.salt)));
    }
    getEIP712TypedData() {
        return {
            types: {
                EIP712Domain: eip712_utils_1.EIP712_DOMAIN_PARAMETERS,
                [RfqLiteOrder.STRUCT_NAME]: RfqLiteOrder.STRUCT_ABI,
            },
            domain: eip712_utils_1.createExchangeProxyEIP712Domain(this.chainId, this.verifyingContract),
            primaryType: RfqLiteOrder.STRUCT_NAME,
            message: {
                makerToken: this.makerToken,
                takerToken: this.takerToken,
                makerAmount: this.makerAmount.toString(10),
...
exports.RfqLiteOrder = RfqLiteOrder;
RfqLiteOrder.STRUCT_NAME = 'RfqLiteOrder';
RfqLiteOrder.STRUCT_ABI = [
    { type: 'address', name: 'makerToken' },
    { type: 'address', name: 'takerToken' },
    { type: 'uint128', name: 'makerAmount' },
    { type: 'uint128', name: 'takerAmount' },
...
RfqLiteOrder.TYPE_HASH = eip712_utils_1.getTypeHash(RfqLiteOrder.STRUCT_NAME, RfqLiteOrder.STRUCT_ABI);
