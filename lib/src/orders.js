...
class OrderBase {
    ...
    _getSignatureWithSignFunctionAsync(
    // TODO: fix typing here
    signFn, type, signer = this.maker) {
        return __awaiter(this, void 0, void 0, function* () {
            switch (type) {
                case signature_utils_1.SignatureType.EIP712:
                    return signature_utils_1.eip712SignTypedDataWithSignatureFnAsync(this.getEIP712TypedData(), signer, signFn);
                case signature_utils_1.SignatureType.EthSign:
                    return signature_utils_1.ethSignHashWithSignatureFnAsync(this.getHash(), signer, signFn);
                default:
                    throw new Error(`Cannot sign with signature type: ${type}`);
            }
        });
