 ...
 */
export declare function ethSignHashWithSignatureFnAsync(hash: string, signer: string, signMessageAsync: (hash: string, signer: string) => Promise<string>): Promise<Signature>;
/**
 * Sign a typed data object with the EIP712 signature type using a compatible signature function
 */
export declare function eip712SignTypedDataWithSignatureFnAsync(data: EIP712TypedData, signer: string, signTypedDataAsync: (typedData: EIP712TypedData, signer: string) => Promise<string>): Promise<Signature>;
/**
