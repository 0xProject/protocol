...
class TreasuryVote {
    ...
    getSignatureWithKey(privateKey) {
        return signature_utils_1.eip712SignHashWithKey(this.getEIP712Hash(), privateKey);
    }
}
...
TreasuryVote.MESSAGE_TYPE_HASH = eip712_utils_1.getTypeHash(TreasuryVote.MESSAGE_STRUCT_NAME, TreasuryVote.MESSAGE_STRUCT_ABI);
TreasuryVote.DOMAIN_STRUCT_NAME = 'EIP712Domain';
TreasuryVote.DOMAIN_TYPE_HASH = eip712_utils_1.getTypeHash(TreasuryVote.DOMAIN_STRUCT_NAME, eip712_utils_1.EIP712_DOMAIN_PARAMETERS);
