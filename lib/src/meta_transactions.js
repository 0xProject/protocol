        ...
        return __awaiter(this, void 0, void 0, function* () {
            switch (type) {
                case signature_utils_1.SignatureType.EIP712:
                    return (0, signature_utils_1.eip712SignTypedDataWithProviderAsync)(this.getEIP712TypedData(), this.signer, provider);
                case signature_utils_1.SignatureType.EthSign:
                    return (0, signature_utils_1.ethSignHashWithProviderAsync)(this.getHash(), this.signer, provider);
                default:
...
MetaTransaction.TYPE_HASH = (0, eip712_utils_1.getTypeHash)(MetaTransaction.STRUCT_NAME, MetaTransaction.STRUCT_ABI);
