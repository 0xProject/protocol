 ...
 */
function getTypeHash(primaryStructName, primaryStructAbi, referencedStructs = {}) {
    ...
    return utils_1.hexUtils.hash(utils_1.hexUtils.toHex(Buffer.from(primaryStructType + referencedStructTypes.join(''))));
}
exports.getTypeHash = getTypeHash;
function encodeType(structName, abi) {
