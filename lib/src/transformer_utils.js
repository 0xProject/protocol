...
function encodeBridgeSourceId(protocol, name) {
    ...
    return utils_1.hexUtils.concat(utils_1.hexUtils.rightPad(utils_1.hexUtils.toHex(Buffer.from(name)), 16), utils_1.hexUtils.leftPad(utils_1.hexUtils.toHex(protocol), 16));
}
