...
contracts_test_utils_1.blockchainTests.resets('Full migration', env => {
    ...
    before(() => __awaiter(this, void 0, void 0, function* () {
        ...
        features = yield migration_1.deployFullFeaturesAsync(env.provider, env.txDefaults, { zeroExAddress: zeroEx.address });
        yield migrator
    ...
    it('Non-deployer cannot call migrateZeroEx()', () => __awaiter(this, void 0, void 0, function* () {
    ...
    const FEATURE_FNS = {
        ...
        NativeOrdersFeature: {
            contractType: wrappers_1.INativeOrdersFeatureContract,
            fns: [
