...
describe('eip712_utils', () => {
    describe('getExchangeProxyEIP712DomainHash()', () => {
        it('computes the correct default hash', () => {
            const actual = (0, eip712_utils_1.getExchangeProxyEIP712DomainHash)();
        ...
        it('computes the correct hash with parameters', () => {
            ...
            const actual = (0, eip712_utils_1.getExchangeProxyEIP712DomainHash)(chainId, verifyingContract);
    ...
    describe('getExchangeProxyEIP712Hash()', () => {
        ...
        it('computes the correct hash', () => {
            const actual = (0, eip712_utils_1.getExchangeProxyEIP712Hash)(structHash);
        ...
        it('computes the correct hash with parameters', () => {
            const chainId = 1337;
            const verifyingContract = '0xfe20c9f78898cf8a3e7c5c2ed36568a3d2ad02b9';
            const actual = (0, eip712_utils_1.getExchangeProxyEIP712Hash)(structHash, chainId, verifyingContract);
