...
describe('signature_utils', () => {
    ...
    describe('ethSignHashWithProviderAsync()', () => {
        it('can sign a hash', () => __awaiter(void 0, void 0, void 0, function* () {
            const actual = yield (0, signature_utils_1.ethSignHashWithProviderAsync)(hash, signer, provider);
            const expected = {
            ...
            (0, chai_1.expect)(actual).to.deep.eq(expected);
        }));
    });
    describe('ethSignHashWithKey()', () => {
        it('can sign a hash', () => __awaiter(void 0, void 0, void 0, function* () {
            const actual = (0, signature_utils_1.ethSignHashWithKey)(hash, key);
            const expected = {
                signatureType: signature_utils_1.SignatureType.EthSign,
    ...
    describe('eip712SignHashWithKey()', () => {
        it('can sign a hash', () => __awaiter(void 0, void 0, void 0, function* () {
            const actual = (0, signature_utils_1.eip712SignHashWithKey)(hash, key);
            const expected = {
    ...
    describe('ecSignHashWithKey()', () => {
        it('can sign a hash', () => __awaiter(void 0, void 0, void 0, function* () {
            const actual = (0, signature_utils_1.ecSignHashWithKey)(hash, key);
            const expected = {
                r: '0x1a01dba0f97d151f696f689e618a8ef6c4e7610a71c2607e18b0d96c741b3e8d',
                s: '0x28fd463b90fd20cf17f16ab6831d712e9bce29619db1bef6e7802318d1de09ed',
                v: 27,
