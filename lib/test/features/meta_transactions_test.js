...
contracts_test_utils_1.blockchainTests.resets('MetaTransactions feature', env => {
    ...
    before(() => __awaiter(this, void 0, void 0, function* () {
        [owner, maker, sender, notSigner, ...signers] = yield env.getAccountAddressesAsync();
        ...
        nativeOrdersFeature = yield wrappers_2.TestMetaTransactionsNativeOrdersFeatureContract.deployFrom0xArtifactAsync(artifacts_1.artifacts.TestMetaTransactionsNativeOrdersFeature, env.provider, env.txDefaults, {});
    ...
    const RAW_TRANSFORM_SUCCESS_RESULT = utils_1.hexUtils.leftPad(1337);
    const RAW_ORDER_SUCCESS_RESULT = utils_1.hexUtils.leftPad(1337, 64);
    describe('executeMetaTransaction()', () => {
        it('can call NativeOrders.fillLimitOrder()', () => __awaiter(this, void 0, void 0, function* () {
            const order = orders_1.getRandomLimitOrder({ maker });
            const fillAmount = new utils_1.BigNumber(23456);
            ...
            const signature = yield mtx.getSignatureWithProviderAsync(env.provider);
            const callOpts = {
                gasPrice: mtx.minGasPrice,
                value: mtx.value,
            };
            const rawResult = yield feature.executeMetaTransaction(mtx, signature).callAsync(callOpts);
            contracts_test_utils_1.expect(rawResult).to.eq(RAW_ORDER_SUCCESS_RESULT);
            ...
            ], wrappers_2.TestMetaTransactionsNativeOrdersFeatureEvents.FillLimitOrderCalled);
        }));
        it('can call NativeOrders.fillRfqOrder()', () => __awaiter(this, void 0, void 0, function* () {
            const order = orders_1.getRandomRfqOrder({ maker });
            const sig = yield order.getSignatureWithProviderAsync(env.provider);
            const fillAmount = new utils_1.BigNumber(23456);
            const mtx = getRandomMetaTransaction({
            ...
            ], wrappers_2.TestMetaTransactionsNativeOrdersFeatureEvents.FillRfqOrderCalled);
        }));
        it('can call `TransformERC20.transformERC20()`', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const rawResult = yield feature.executeMetaTransaction(mtx, signature).callAsync(callOpts);
            contracts_test_utils_1.expect(rawResult).to.eq(RAW_TRANSFORM_SUCCESS_RESULT);
            const receipt = yield feature.executeMetaTransaction(mtx, signature).awaitTransactionSuccessAsync(callOpts);
            contracts_test_utils_1.verifyEventsFromLogs(receipt.logs, [
                {
        ...
        it('can call `TransformERC20.transformERC20()` with calldata', () => __awaiter(this, void 0, void 0, function* () {
            const args = getRandomTransformERC20Args();
        ...
        it('fails if signature is wrong', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const mtxHash = mtx.getHash();
            const signature = yield mtx.clone({ signer: notSigner }).getSignatureWithProviderAsync(env.provider);
            const callOpts = {
                gasPrice: mtx.maxGasPrice,
                value: mtx.value,
            };
            const tx = feature.executeMetaTransaction(mtx, signature).awaitTransactionSuccessAsync(callOpts);
            return contracts_test_utils_1.expect(tx).to.revertWith(new utils_1.ZeroExRevertErrors.SignatureValidator.SignatureValidationError(utils_1.ZeroExRevertErrors.SignatureValidator.SignatureValidationErrorCodes.WrongSigner, mtxHash, signers[0], '0x'));
        }));
    ...
    describe('batchExecuteMetaTransactions()', () => {
        it('can execute multiple transactions', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const signatures = yield Promise.all(mtxs.map((mtx) => __awaiter(this, void 0, void 0, function* () { return mtx.getSignatureWithProviderAsync(env.provider); })));
            const callOpts = {
            ...
            contracts_test_utils_1.expect(rawResults).to.eql(mtxs.map(() => RAW_TRANSFORM_SUCCESS_RESULT));
        }));
        it('cannot execute the same transaction twice', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const signatures = yield Promise.all(mtxs.map((m) => __awaiter(this, void 0, void 0, function* () { return m.getSignatureWithProviderAsync(env.provider); })));
            const callOpts = {
