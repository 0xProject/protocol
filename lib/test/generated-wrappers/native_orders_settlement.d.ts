...
export declare type NativeOrdersSettlementEventArgs = NativeOrdersSettlementLimitOrderFilledEventArgs | NativeOrdersSettlementOrderCancelledEventArgs | NativeOrdersSettlementPairCancelledLimitOrdersEventArgs | NativeOrdersSettlementPairCancelledRfqOrdersEventArgs | NativeOrdersSettlementRfqOrderFilledEventArgs | NativeOrdersSettlementRfqOrderOriginsAllowedEventArgs;
export declare enum NativeOrdersSettlementEvents {
...
export interface NativeOrdersSettlementLimitOrderFilledEventArgs extends DecodedLogArgs {
    orderHash: string;
    maker: string;
    taker: string;
    feeRecipient: string;
...
export interface NativeOrdersSettlementOrderCancelledEventArgs extends DecodedLogArgs {
    orderHash: string;
    maker: string;
}
export interface NativeOrdersSettlementPairCancelledLimitOrdersEventArgs extends DecodedLogArgs {
    maker: string;
    makerToken: string;
    takerToken: string;
    minValidSalt: BigNumber;
}
export interface NativeOrdersSettlementPairCancelledRfqOrdersEventArgs extends DecodedLogArgs {
    maker: string;
    makerToken: string;
    takerToken: string;
    minValidSalt: BigNumber;
}
export interface NativeOrdersSettlementRfqOrderFilledEventArgs extends DecodedLogArgs {
    orderHash: string;
    maker: string;
    taker: string;
    makerToken: string;
...
export interface NativeOrdersSettlementRfqOrderOriginsAllowedEventArgs extends DecodedLogArgs {
    origin: string;
    addrs: string[];
    allowed: boolean;
}
export declare class NativeOrdersSettlementContract extends BaseContract {
    /**
     * @ignore
     */
    ...
    }, zeroExAddress: string, weth: string, staking: string, feeCollectorController: string, protocolFeeMultiplier: number | BigNumber, greedyTokensBloomFilter: string): Promise<NativeOrdersSettlementContract>;
 ...
 * the staking contract.
    ...
    /**
     * Subscribe to an event type emitted by the NativeOrdersSettlement contract.
     * @param eventName The NativeOrdersSettlement contract event you would like to subscribe to.
     ...
     */
    subscribe<ArgsType extends NativeOrdersSettlementEventArgs>(eventName: NativeOrdersSettlementEvents, indexFilterValues: IndexedFilterValues, callback: EventCallback<ArgsType>, isVerbose?: boolean, blockPollingIntervalMs?: number): string;
    /**
     ...
     */
    getLogsAsync<ArgsType extends NativeOrdersSettlementEventArgs>(eventName: NativeOrdersSettlementEvents, blockRange: BlockRange, indexFilterValues: IndexedFilterValues): Promise<Array<LogWithDecodedArgs<ArgsType>>>;
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>, logDecodeDependencies?: {
        [contractName: string]: ContractAbi;
    }, deployedBytecode?: string | undefined);
}
//# sourceMappingURL=native_orders_settlement.d.ts.map