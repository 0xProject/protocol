...
var NativeOrdersFeatureEvents;
(function (NativeOrdersFeatureEvents) {
    NativeOrdersFeatureEvents["LimitOrderFilled"] = "LimitOrderFilled";
    NativeOrdersFeatureEvents["OrderCancelled"] = "OrderCancelled";
    NativeOrdersFeatureEvents["PairCancelledLimitOrders"] = "PairCancelledLimitOrders";
    NativeOrdersFeatureEvents["PairCancelledRfqOrders"] = "PairCancelledRfqOrders";
    NativeOrdersFeatureEvents["RfqOrderFilled"] = "RfqOrderFilled";
    NativeOrdersFeatureEvents["RfqOrderOriginsAllowed"] = "RfqOrderOriginsAllowed";
})(NativeOrdersFeatureEvents = exports.NativeOrdersFeatureEvents || (exports.NativeOrdersFeatureEvents = {}));
/* istanbul ignore next */
// tslint:disable:array-type
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
class NativeOrdersFeatureContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = NativeOrdersFeatureContract.deployedBytecode) {
        super('NativeOrdersFeature', NativeOrdersFeatureContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode);
        this._methodABIIndex = {};
        utils_1.classUtils.bindAll(this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        this._subscriptionManager = new base_contract_1.SubscriptionManager(NativeOrdersFeatureContract.ABI(), this._web3Wrapper);
        NativeOrdersFeatureContract.ABI().forEach((item, index) => {
    ...
    static deployFrom0xArtifactAsync(artifact, supportedProvider, txDefaults, logDecodeDependencies, zeroExAddress, weth, staking, feeCollectorController, protocolFeeMultiplier, greedyTokensBloomFilter) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return NativeOrdersFeatureContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, zeroExAddress, weth, staking, feeCollectorController, protocolFeeMultiplier, greedyTokensBloomFilter);
        });
    }
    static deployWithLibrariesFrom0xArtifactAsync(artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies, zeroExAddress, weth, staking, feeCollectorController, protocolFeeMultiplier, greedyTokensBloomFilter) {
        return __awaiter(this, void 0, void 0, function* () {
            assert_1.assert.doesConformToSchema('txDefaults', txDefaults, json_schemas_1.schemas.txDataSchema, [
                json_schemas_1.schemas.addressSchema,
                json_schemas_1.schemas.numberSchema,
            ...
            const libraryAddresses = yield NativeOrdersFeatureContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults);
            const bytecode = base_contract_1.linkLibrariesInBytecode(artifact, libraryAddresses);
            return NativeOrdersFeatureContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, zeroExAddress, weth, staking, feeCollectorController, protocolFeeMultiplier, greedyTokensBloomFilter);
        });
    }
    static deployAsync(bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies, zeroExAddress, weth, staking, feeCollectorController, protocolFeeMultiplier, greedyTokensBloomFilter) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            utils_1.logUtils.log(`NativeOrdersFeature successfully deployed at ${txReceipt.contractAddress}`);
            const contractInstance = new NativeOrdersFeatureContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
            ...
            for (const link of Object.values(links)) {
                for (const libraryName of Object.keys(link)) {
                    if (!libraryAddresses[libraryName]) {
                        ...
                        yield NativeOrdersFeatureContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses);
                        // Deploy this library.
    ...
    getFunctionSignature(methodName) {
        ...
        const methodAbi = NativeOrdersFeatureContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
 ...
 * the staking contract.
    ...
    subscribe(eventName, indexFilterValues, callback, isVerbose = false, blockPollingIntervalMs) {
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, NativeOrdersFeatureEvents);
        ...
        const subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, NativeOrdersFeatureContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
    ...
    getLogsAsync(eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
            const logs = yield this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, NativeOrdersFeatureContract.ABI());
            return logs;
        });
    }
}
NativeOrdersFeatureContract.contractName = 'NativeOrdersFeature';
exports.NativeOrdersFeatureContract = NativeOrdersFeatureContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=native_orders_feature.js.map