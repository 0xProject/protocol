...
class BatchFillNativeOrdersFeatureContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = BatchFillNativeOrdersFeatureContract.deployedBytecode) {
        super('BatchFillNativeOrdersFeature', BatchFillNativeOrdersFeatureContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode);
