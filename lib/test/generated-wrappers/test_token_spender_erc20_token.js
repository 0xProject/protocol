...
class TestTokenSpenderERC20TokenContract extends base_contract_1.BaseContract {
    ...
    ;
    approveAs(owner, spender, amount) {
        const self = this;
        assert_1.assert.isString('owner', owner);
        assert_1.assert.isString('spender', spender);
        assert_1.assert.isBigNumber('amount', amount);
        const functionSignature = 'approveAs(address,address,uint256)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    ;
    setGreedyRevert(isGreedy) {
        const self = this;
        assert_1.assert.isBoolean('isGreedy', isGreedy);
        const functionSignature = 'setGreedyRevert(bool)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
            ...
            getABIEncodedTransactionData() {
                return self._strictEncodeArguments(functionSignature, [isGreedy
                ]);
            },
        };
    }
