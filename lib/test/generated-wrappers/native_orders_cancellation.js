...
var NativeOrdersCancellationEvents;
(function (NativeOrdersCancellationEvents) {
    NativeOrdersCancellationEvents["LimitOrderFilled"] = "LimitOrderFilled";
    NativeOrdersCancellationEvents["OrderCancelled"] = "OrderCancelled";
    NativeOrdersCancellationEvents["PairCancelledLimitOrders"] = "PairCancelledLimitOrders";
    NativeOrdersCancellationEvents["PairCancelledRfqOrders"] = "PairCancelledRfqOrders";
    NativeOrdersCancellationEvents["RfqOrderFilled"] = "RfqOrderFilled";
    NativeOrdersCancellationEvents["RfqOrderOriginsAllowed"] = "RfqOrderOriginsAllowed";
})(NativeOrdersCancellationEvents = exports.NativeOrdersCancellationEvents || (exports.NativeOrdersCancellationEvents = {}));
/* istanbul ignore next */
// tslint:disable:array-type
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
class NativeOrdersCancellationContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = NativeOrdersCancellationContract.deployedBytecode) {
        super('NativeOrdersCancellation', NativeOrdersCancellationContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode);
        this._methodABIIndex = {};
        utils_1.classUtils.bindAll(this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        this._subscriptionManager = new base_contract_1.SubscriptionManager(NativeOrdersCancellationContract.ABI(), this._web3Wrapper);
        NativeOrdersCancellationContract.ABI().forEach((item, index) => {
    ...
    static deployFrom0xArtifactAsync(artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return NativeOrdersCancellationContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly);
        });
    }
    static deployWithLibrariesFrom0xArtifactAsync(artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const libraryAddresses = yield NativeOrdersCancellationContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults);
    ...
    static deployAsync(bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            utils_1.logUtils.log(`NativeOrdersCancellation successfully deployed at ${txReceipt.contractAddress}`);
            const contractInstance = new NativeOrdersCancellationContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
            ...
            for (const link of Object.values(links)) {
                for (const libraryName of Object.keys(link)) {
                    if (!libraryAddresses[libraryName]) {
                        ...
                        yield NativeOrdersCancellationContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses);
                        // Deploy this library.
    ...
    getFunctionSignature(methodName) {
        ...
        const methodAbi = NativeOrdersCancellationContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
 ...
 * Fillable amount is determined using balances and allowances of the maker.
    ...
    subscribe(eventName, indexFilterValues, callback, isVerbose = false, blockPollingIntervalMs) {
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, NativeOrdersCancellationEvents);
        ...
        const subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, NativeOrdersCancellationContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
    ...
    getLogsAsync(eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
            const logs = yield this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, NativeOrdersCancellationContract.ABI());
            return logs;
        });
    }
}
NativeOrdersCancellationContract.contractName = 'NativeOrdersCancellation';
exports.NativeOrdersCancellationContract = NativeOrdersCancellationContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=native_orders_cancellation.js.map