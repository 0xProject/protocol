...
export declare type TestNativeOrdersFeatureEventArgs = TestNativeOrdersFeatureLimitOrderFilledEventArgs | TestNativeOrdersFeatureOrderCancelledEventArgs | TestNativeOrdersFeaturePairCancelledLimitOrdersEventArgs | TestNativeOrdersFeaturePairCancelledRfqOrdersEventArgs | TestNativeOrdersFeatureRfqOrderFilledEventArgs | TestNativeOrdersFeatureRfqOrderOriginsAllowedEventArgs;
export declare enum TestNativeOrdersFeatureEvents {
...
export interface TestNativeOrdersFeatureLimitOrderFilledEventArgs extends DecodedLogArgs {
    orderHash: string;
    maker: string;
    taker: string;
    feeRecipient: string;
...
export interface TestNativeOrdersFeatureOrderCancelledEventArgs extends DecodedLogArgs {
    orderHash: string;
    maker: string;
}
export interface TestNativeOrdersFeaturePairCancelledLimitOrdersEventArgs extends DecodedLogArgs {
    maker: string;
    makerToken: string;
    takerToken: string;
    minValidSalt: BigNumber;
}
export interface TestNativeOrdersFeaturePairCancelledRfqOrdersEventArgs extends DecodedLogArgs {
    maker: string;
    makerToken: string;
    takerToken: string;
    minValidSalt: BigNumber;
}
export interface TestNativeOrdersFeatureRfqOrderFilledEventArgs extends DecodedLogArgs {
    orderHash: string;
    maker: string;
    taker: string;
    makerToken: string;
...
export interface TestNativeOrdersFeatureRfqOrderOriginsAllowedEventArgs extends DecodedLogArgs {
    origin: string;
    addrs: string[];
    allowed: boolean;
}
export declare class TestNativeOrdersFeatureContract extends BaseContract {
    /**
     * @ignore
     */
    ...
    }, zeroExAddress: string, weth: string, staking: string, _feeCollectorController: string, protocolFeeMultiplier: number | BigNumber, greedyTokensBloomFilter: string): Promise<TestNativeOrdersFeatureContract>;
 ...
 * the staking contract.
     ...
     */
    subscribe<ArgsType extends TestNativeOrdersFeatureEventArgs>(eventName: TestNativeOrdersFeatureEvents, indexFilterValues: IndexedFilterValues, callback: EventCallback<ArgsType>, isVerbose?: boolean, blockPollingIntervalMs?: number): string;
    /**
     ...
     */
    getLogsAsync<ArgsType extends TestNativeOrdersFeatureEventArgs>(eventName: TestNativeOrdersFeatureEvents, blockRange: BlockRange, indexFilterValues: IndexedFilterValues): Promise<Array<LogWithDecodedArgs<ArgsType>>>;
    constructor(address: string, supportedProvider: SupportedProvider, txDefaults?: Partial<TxData>, logDecodeDependencies?: {
        [contractName: string]: ContractAbi;
    }, deployedBytecode?: string | undefined);
}
//# sourceMappingURL=test_native_orders_feature.d.ts.map