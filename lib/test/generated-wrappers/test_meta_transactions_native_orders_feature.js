...
var TestMetaTransactionsNativeOrdersFeatureEvents;
(function (TestMetaTransactionsNativeOrdersFeatureEvents) {
    TestMetaTransactionsNativeOrdersFeatureEvents["FillLimitOrderCalled"] = "FillLimitOrderCalled";
    TestMetaTransactionsNativeOrdersFeatureEvents["FillRfqOrderCalled"] = "FillRfqOrderCalled";
    TestMetaTransactionsNativeOrdersFeatureEvents["LimitOrderFilled"] = "LimitOrderFilled";
    TestMetaTransactionsNativeOrdersFeatureEvents["OrderCancelled"] = "OrderCancelled";
    TestMetaTransactionsNativeOrdersFeatureEvents["PairCancelledLimitOrders"] = "PairCancelledLimitOrders";
    TestMetaTransactionsNativeOrdersFeatureEvents["PairCancelledRfqOrders"] = "PairCancelledRfqOrders";
    TestMetaTransactionsNativeOrdersFeatureEvents["RfqOrderFilled"] = "RfqOrderFilled";
    TestMetaTransactionsNativeOrdersFeatureEvents["RfqOrderOriginsAllowed"] = "RfqOrderOriginsAllowed";
})(TestMetaTransactionsNativeOrdersFeatureEvents = exports.TestMetaTransactionsNativeOrdersFeatureEvents || (exports.TestMetaTransactionsNativeOrdersFeatureEvents = {}));
/* istanbul ignore next */
// tslint:disable:array-type
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
class TestMetaTransactionsNativeOrdersFeatureContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = TestMetaTransactionsNativeOrdersFeatureContract.deployedBytecode) {
        super('TestMetaTransactionsNativeOrdersFeature', TestMetaTransactionsNativeOrdersFeatureContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode);
        this._methodABIIndex = {};
        utils_1.classUtils.bindAll(this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        this._subscriptionManager = new base_contract_1.SubscriptionManager(TestMetaTransactionsNativeOrdersFeatureContract.ABI(), this._web3Wrapper);
        TestMetaTransactionsNativeOrdersFeatureContract.ABI().forEach((item, index) => {
    ...
    static deployFrom0xArtifactAsync(artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return TestMetaTransactionsNativeOrdersFeatureContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly);
        });
    }
    static deployWithLibrariesFrom0xArtifactAsync(artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const libraryAddresses = yield TestMetaTransactionsNativeOrdersFeatureContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults);
    ...
    static deployAsync(bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            utils_1.logUtils.log(`TestMetaTransactionsNativeOrdersFeature successfully deployed at ${txReceipt.contractAddress}`);
            const contractInstance = new TestMetaTransactionsNativeOrdersFeatureContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
            ...
            for (const link of Object.values(links)) {
                for (const libraryName of Object.keys(link)) {
                    if (!libraryAddresses[libraryName]) {
                        ...
                        yield TestMetaTransactionsNativeOrdersFeatureContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses);
                        // Deploy this library.
    ...
    getFunctionSignature(methodName) {
        ...
        const methodAbi = TestMetaTransactionsNativeOrdersFeatureContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
    ...
    GREEDY_TOKENS_BLOOM_FILTER() {
        const self = this;
        const functionSignature = 'GREEDY_TOKENS_BLOOM_FILTER()';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
    ...
    PROTOCOL_FEE_MULTIPLIER() {
        const self = this;
        const functionSignature = 'PROTOCOL_FEE_MULTIPLIER()';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
 ...
 * the staking contract.
    ...
    ;
    /**
     * Subscribe to an event type emitted by the TestMetaTransactionsNativeOrdersFeature contract.
     * @param eventName The TestMetaTransactionsNativeOrdersFeature contract event you would like to subscribe to.
    ...
    subscribe(eventName, indexFilterValues, callback, isVerbose = false, blockPollingIntervalMs) {
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, TestMetaTransactionsNativeOrdersFeatureEvents);
        ...
        const subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, TestMetaTransactionsNativeOrdersFeatureContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
    ...
    getLogsAsync(eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
            const logs = yield this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, TestMetaTransactionsNativeOrdersFeatureContract.ABI());
            return logs;
        });
    }
}
TestMetaTransactionsNativeOrdersFeatureContract.contractName = 'TestMetaTransactionsNativeOrdersFeature';
exports.TestMetaTransactionsNativeOrdersFeatureContract = TestMetaTransactionsNativeOrdersFeatureContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=test_meta_transactions_native_orders_feature.js.map