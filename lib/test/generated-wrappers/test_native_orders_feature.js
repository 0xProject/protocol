...
var TestNativeOrdersFeatureEvents;
(function (TestNativeOrdersFeatureEvents) {
    TestNativeOrdersFeatureEvents["LimitOrderFilled"] = "LimitOrderFilled";
    TestNativeOrdersFeatureEvents["OrderCancelled"] = "OrderCancelled";
    TestNativeOrdersFeatureEvents["PairCancelledLimitOrders"] = "PairCancelledLimitOrders";
    TestNativeOrdersFeatureEvents["PairCancelledRfqOrders"] = "PairCancelledRfqOrders";
    TestNativeOrdersFeatureEvents["RfqOrderFilled"] = "RfqOrderFilled";
    TestNativeOrdersFeatureEvents["RfqOrderOriginsAllowed"] = "RfqOrderOriginsAllowed";
})(TestNativeOrdersFeatureEvents = exports.TestNativeOrdersFeatureEvents || (exports.TestNativeOrdersFeatureEvents = {}));
/* istanbul ignore next */
// tslint:disable:array-type
// tslint:disable:no-parameter-reassignment
// tslint:disable-next-line:class-name
class TestNativeOrdersFeatureContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = TestNativeOrdersFeatureContract.deployedBytecode) {
        super('TestNativeOrdersFeature', TestNativeOrdersFeatureContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode);
        this._methodABIIndex = {};
        utils_1.classUtils.bindAll(this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        this._subscriptionManager = new base_contract_1.SubscriptionManager(TestNativeOrdersFeatureContract.ABI(), this._web3Wrapper);
        TestNativeOrdersFeatureContract.ABI().forEach((item, index) => {
    ...
    static deployFrom0xArtifactAsync(artifact, supportedProvider, txDefaults, logDecodeDependencies, zeroExAddress, weth, staking, _feeCollectorController, protocolFeeMultiplier, greedyTokensBloomFilter) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return TestNativeOrdersFeatureContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, zeroExAddress, weth, staking, _feeCollectorController, protocolFeeMultiplier, greedyTokensBloomFilter);
        });
    }
    static deployWithLibrariesFrom0xArtifactAsync(artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies, zeroExAddress, weth, staking, _feeCollectorController, protocolFeeMultiplier, greedyTokensBloomFilter) {
        return __awaiter(this, void 0, void 0, function* () {
            assert_1.assert.doesConformToSchema('txDefaults', txDefaults, json_schemas_1.schemas.txDataSchema, [
                json_schemas_1.schemas.addressSchema,
                json_schemas_1.schemas.numberSchema,
            ...
            const libraryAddresses = yield TestNativeOrdersFeatureContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults);
            const bytecode = base_contract_1.linkLibrariesInBytecode(artifact, libraryAddresses);
            return TestNativeOrdersFeatureContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, zeroExAddress, weth, staking, _feeCollectorController, protocolFeeMultiplier, greedyTokensBloomFilter);
        });
    }
    static deployAsync(bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies, zeroExAddress, weth, staking, _feeCollectorController, protocolFeeMultiplier, greedyTokensBloomFilter) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            utils_1.logUtils.log(`TestNativeOrdersFeature successfully deployed at ${txReceipt.contractAddress}`);
            const contractInstance = new TestNativeOrdersFeatureContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
            ...
            for (const link of Object.values(links)) {
                for (const libraryName of Object.keys(link)) {
                    if (!libraryAddresses[libraryName]) {
                        ...
                        yield TestNativeOrdersFeatureContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses);
                        // Deploy this library.
    ...
    getFunctionSignature(methodName) {
        ...
        const methodAbi = TestNativeOrdersFeatureContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
 ...
 * the staking contract.
    ...
    ;
    /**
     * Subscribe to an event type emitted by the TestNativeOrdersFeature contract.
     * @param eventName The TestNativeOrdersFeature contract event you would like to subscribe to.
    ...
    subscribe(eventName, indexFilterValues, callback, isVerbose = false, blockPollingIntervalMs) {
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, TestNativeOrdersFeatureEvents);
        ...
        const subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, TestNativeOrdersFeatureContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
    ...
    getLogsAsync(eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
            const logs = yield this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, TestNativeOrdersFeatureContract.ABI());
            return logs;
        });
    }
}
TestNativeOrdersFeatureContract.contractName = 'TestNativeOrdersFeature';
exports.TestNativeOrdersFeatureContract = TestNativeOrdersFeatureContract;
// tslint:disable:max-file-line-count
// tslint:enable:no-unbound-method no-parameter-reassignment no-consecutive-blank-lines ordered-imports align
// tslint:enable:trailing-comma whitespace no-trailing-whitespace
//# sourceMappingURL=test_native_orders_feature.js.map