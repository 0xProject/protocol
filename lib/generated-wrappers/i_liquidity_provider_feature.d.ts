...
export declare type ILiquidityProviderFeatureEventArgs = ILiquidityProviderFeatureLiquidityProviderSwapEventArgs;
export declare enum ILiquidityProviderFeatureEvents {
    LiquidityProviderSwap = "LiquidityProviderSwap"
}
export interface ILiquidityProviderFeatureLiquidityProviderSwapEventArgs extends DecodedLogArgs {
    inputToken: string;
    outputToken: string;
