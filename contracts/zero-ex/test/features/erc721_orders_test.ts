...
import { getRandomERC721Order } from '../utils/erc721_orders';
import { fullMigrateAsync } from '../utils/migration';

import {
    ERC721OrdersFeatureContract,
    TestERC721OrderPresignerContract,
...
blockchainTests.resets.only('ERC721OrdersFeature', env => {
    ...
    describe('preSignERC721Order', () => {
        ...
        let contractMaker: TestERC721OrderPresignerContract;
        before(async () => {
            contractMaker = await TestERC721OrderPresignerContract.deployFrom0xArtifactAsync(
                artifacts.TestERC721OrderPresigner,
                env.provider,
                env.txDefaults,
                artifacts,
                zeroEx.address,
