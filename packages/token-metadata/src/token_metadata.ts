...
export const TokenMetadatasForChains: TokenMetadataAndChainAddresses[] = [
    {
        ...
        tokenAddresses: valueByChainId(
            {
                [ChainId.BSC]: NULL_ADDRESS,
                [ChainId.Polygon]: NULL_ADDRESS,
            },
            ETH_TOKEN_ADDRESS,
        ),
    },
        ...
        tokenAddresses: valueByChainId(
            {
                ...
                [ChainId.Polygon]: ETH_TOKEN_ADDRESS,
            },
            NULL_ADDRESS,
        ),
    },
    ...
    },
    {
        ...
        tokenAddresses: valueByChainId(
            {
                [ChainId.Ropsten]: '0xf84830b73b2ed3c7267e7638f500110ea47fdf30',
            },
            NULL_ADDRESS,
        ),
    },
    {
        ...
        tokenAddresses: valueByChainId(
            {
                [ChainId.Ropsten]: '0x374a16f5e686c09b0cc9e8bc3466b3b645c74aa7',
            },
            NULL_ADDRESS,
        ),
    },
