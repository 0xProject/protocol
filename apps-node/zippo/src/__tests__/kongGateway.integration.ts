...
describe("kong gateway integration", () => {
  ...
  describe("kong consumer", () => {
    ...
    it("should create a request transformer", async () => {
      await expect(
        kongEnsureRequestTransformer("project1", "integrator1")
  ...
  describe("kong keys", () => {
    ...
    it("should start with an empty kong configuration", async () => {
      ...
      await expect(
        kongGetKey("project1", "56ce736a-37d4-40e4-8d19-820f849383b3")
      ).resolves.toBeNull();
    });

    it("should create a new key", async () => {
      await expect(
        kongEnsureKey("project1", "56ce736a-37d4-40e4-8d19-820f849383b3")
      ).resolves.toEqual(
        expect.objectContaining({
  ...
  describe("kong acl", () => {
    ...
    it("should start with an empty kong configuration", async () => {
      ...
      await expect(
        kongGetAcl("project1", "swap_v1_price_group")
      ).resolves.toBeNull();
    });

    it("should create the project ACL membership", async () => {
      await expect(
        kongEnsureAcl("project1", "swap_v1_price_group")
      ).resolves.toEqual(
        expect.objectContaining({
  ...
  describe("kong rate limit", () => {
    ...
    it("should start with an empty kong configuration", async () => {
      await expect(kongEnsureConsumer("project1")).resolves.not.toBeNull();
      await expect(
        kongGetRateLimit("project1", "swap_price_v1_route_optimism")
      ).resolves.toBeNull();
      await expect(
        kongGetRateLimit("project1", "swap_price_v1_route_fantom")
      ).resolves.toBeNull();
    });
  ...
  describe("kong remove key", () => {
    ...
    it("should remove a project key", async () => {
      await expect(
        kongRemoveKey("project1", "56ce736a-37d4-40e4-8d19-820f849383b3")
      ).resolves.toBeTruthy();
    });
  ...
  describe("kong remove acl", () => {
    ...
    it("should remove ACL membership", async () => {
      await expect(
        kongRemoveAcl("project1", "swap_v1_price_group")
      ).resolves.toBeTruthy();
    });
  ...
  describe("kong remove rate limit", () => {
    ...
    it("should remove rate-limit from project", async () => {
      await expect(
        kongRemoveRateLimit("project1", "swap_price_v1_route_optimism")
      ).resolves.toBeTruthy();
      await expect(
        kongRemoveRateLimit("project1", "swap_price_v1_route_fantom")
      ).resolves.toBeTruthy();
    });
