...
export class MetaTransactionService implements IMetaTransactionService {
    ...
    /**
     * Generate meta-transaction v2.
     *
     * @param callData Generated calldata meta-transaction v2 wraps around.
     * @param takerAddress Address of the taker.
     * @param feeToken Fee token (sell token).
            ...
            publishQuoteReport(
                {
                    ...
                    quotedSellAmount: quote.buyAmount,
